export const dialogue = [
  ...
  {
    id: "2-ar",
    text: "كتير من الطلاب بتفكر انه اذا وحدت اجابتها لكل اسئلة الخيارات فهي هيك لح تكون ضمنت أكبر عدد من الإجابات الصحيحة لانه لو شلفت كلشي فاحتمال كون غلط بكلشي ما؟ اما لو كل الإجابات من نفس النوع فلح اضمن نص العلامة",
  },
  {
    id: "2-en",
  ...
  {
    id: "4-ar",
    text: "هي نتائج المحاكاة قدامك حتلاقي معي انه كل استراتيجيات التشليف الها نفس التوزيع ونفس الانحراف المعياري ونفس المتوسط الحسابي يعني نفس الشي!!",
  },
  {
    id: "4-en",
