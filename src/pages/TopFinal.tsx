...
const TopFinal = ({ Score , selectedLanguage }: { Score: number , selectedLanguage:string}) => {
  return (
    <div className="flex flex-col w-full justify-center items-center ">
      <div className="stats shadow justify-center items-center">
        <div className="stat w-full justify-center items-center">
          <div className="stat-title w-full justify-center items-center">{selectedLanguage==='en'&&<p>You Scored</p>}{selectedLanguage==='ar'&&<p>نتيجتك كانت</p>}</div>
